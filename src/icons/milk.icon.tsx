...
export const MilkIcon = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <g>
      ...
      <path
        style={{ fill: '#FFFFFF' }}
        d="M34.215,16.875L34.215,16.875c-2.217,0.58-2.956-1.423-3.305-2.753l0,0
  c-0.348-1.33-0.684-3.439,1.533-4.019l0,0c2.217-0.58,2.956,1.423,3.304,2.753v0C36.095,14.186,36.432,16.295,34.215,16.875z"
      />
      <polygon
        style={{ fill: '#EDEDED' }}
        points="34,4.842 36,4.421 36,0.421 34,0.842"
      />
      <polygon
        style={{ fill: '#EDEDED' }}
        points="30,5.684 32,5.263 32,1.263 30,1.684"
      />
      <polygon
        style={{ fill: '#EDEDED' }}
        points="26,6.526 28,6.105 28,2.105 26,2.526"
      />
      <polygon
        style={{ fill: '#EDEDED' }}
        points="22,7.368 24,6.947 24,2.947 22,3.368"
      />
    </g>
  </svg>
);
